...
export function CartSummary() {
    ...
    return (
        <div className={cn(hidden && "translate-x-56 opacity-30", "transition-all  hidden  sm:block  sm:fixed right-4 top-24 text-black bg-white p-2 md:p-4 rounded-lg shadow-md w-64")}>
