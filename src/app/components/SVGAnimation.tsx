...
export const SVGAnimation = () => {
    return (
        <div className="animate-swim absolute left-[-20vh] z-50" >
            <svg
                fill="#dd6b20" height="100px" width="100px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="-46.6 -46.6 559.20 559.20" xmlSpace="preserve" transform="rotate(0)matrix(-1, 0, 0, 1, 0, 0)" stroke="#dd6b20" strokeWidth="0.00466002">
                <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" stroke="#CCCCCC" strokeWidth="2.8"></g>
